          ...
          render={({ field }) => (
            <>
              ...
              <button
                ...
                type="button"
                className="h-full px-3  text-foreground/60 hover:text-blue-600"
              >
                {!showEmojiPicker ? (
              ...
              <button
                type="submit"
                className="h-full pl-4 pr-10  text-foreground/60 hover:text-blue-600"
              >
                <Send />
              </button>
            </>
        ...
        {showEmojiPicker && (
          <EmojiPicker
            ...
            onEmojiClick={(emoji) => {
              ...
              form.setValue("message", current + emoji.emoji);
            }}
          />
        )}
      </form>
...
const Messages = () => {
  ...
  messages.forEach((msg) => {
    ...
    else key = format(date, "dd MMMM yyyy"); // Example: 20 April 2025
  ...
  return (
    <>
      ...
      <div className="block space-y-2">
        {Object.entries(groups).map(([date, messages], index) => (
          <div key={index} className="flex flex-col space-y-2">
            <div className="sticky -top-8 text-sm text-center z-10 bg-neutral pt-1.5">
              {date}
            </div>
